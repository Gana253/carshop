...
import com.java.car.repository.LocationRepository;
...
public class LocationResourceIT {
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].lat").value(hasItem(DEFAULT_LATITUDE)))
                .andExpect(jsonPath("$.[*].long").value(hasItem(DEFAULT_LONGITUDE)));
    }
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
                ...
                .andExpect(jsonPath("$.lat").value(DEFAULT_LATITUDE))
                .andExpect(jsonPath("$.long").value(DEFAULT_LONGITUDE));
    }
